...
class Indy {
    ...
    private val universityWalletConfig = JSONObject().put("id", "universityWallet").toString()
    private val universityWalletCredentials = JSONObject().put("key", "university_wallet_key").toString()

    private val companyWalletConfig = JSONObject().put("id", "companyWallet").toString()
    private val companyWalletCredentials = JSONObject().put("key", "company_wallet_key").toString()

    private val governmentWalletConfig = JSONObject().put("id", "governmentWallet").toString()
    private val governmentWalletCredentials = JSONObject().put("key", "government_wallet_key").toString()

    private val myWalletConfig = JSONObject().put("id", "myWallet").toString()
    private val myWalletCredentials = JSONObject().put("key", "my_wallet_key").toString()
    ...
    fun createIdentityCredOffer() {
        ...
        val identityCertificateCredDefConfigJson = JSONObject().put("support_revocation", false).toString()
    ...
    fun createDegreeCredOffer() {
        ...
        val bachelorCertificateCredDefConfigJson = JSONObject().put("support_revocation", false).toString()
    ...
    fun createJobCredOffer() {
        ...
        val jobCertificateCredDefConfigJson = JSONObject().put("support_revocation", false).toString()
        ...
        jobCredOffer = Anoncreds.issuerCreateCredentialOffer(companyWallet, jobCertificateCredDefId)
            .get()
    ...
    fun requestIdentityCertificate() {
        ...
        val identityCredValuesJson = JSONObject()
            .put("family_name", JSONObject().put("raw", "Garcia").put("encoded", "946510486021438157324488086511345775493242887916"))
            //.put("birth_name", JSONObject().put("raw", "").put("encoded", ""))
            .put("given_names", JSONObject().put("raw", "Alice").put("encoded", "303680606261854555853193981910306662446219611633"))
            //.put("doctoral_degree", JSONObject().put("raw", "").put("encoded", ""))
            .put("date_of_birth", JSONObject().put("raw", "1964-08-12").put("encoded", "19640812"))
            .put("place_of_birth", JSONObject().put("raw", "Berlin").put("encoded", "35213462824075338563596693498506032610897976097"))
            .put("address", JSONObject().put("raw", "Sample street 12, 12059 Berlin").put("encoded", "947397614802691795330029495488188401319414724640"))
            .put("nationality", JSONObject().put("raw", "German").put("encoded", "1247798522173559676754790998791794996059419723869"))
            .put("document_type", JSONObject().put("raw", "Identity card").put("encoded", "144992736518735056036859271803104200336197691206"))
            .put("valid_until", JSONObject().put("raw", "20291031").put("encoded", "20291031"))
            .put("issuing_country", JSONObject().put("raw", "Germany").put("encoded", "136062252323357910523596751724311663715246877932"))
    ...
    fun proofRequestDegreeCertificate() {
        ...
        val degreeRequestCredentialsSearch = CredentialsSearchForProofReq.open(myWallet, degreeRequestProofRequestJson, null).get()

        val degreeRequestCredentialsForAttribute1 = JSONArray(degreeRequestCredentialsSearch.fetchNextCredentials("attr1_referent", 100).get())
        val degreeRequestCredentialIdForAttribute1 = degreeRequestCredentialsForAttribute1.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 1: $degreeRequestCredentialsForAttribute1")

        val degreeRequestCredentialsForAttribute2 = JSONArray(degreeRequestCredentialsSearch.fetchNextCredentials("attr2_referent", 100).get())
        val degreeRequestCredentialIdForAttribute2 = degreeRequestCredentialsForAttribute2.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 2: $degreeRequestCredentialsForAttribute2")

        val degreeRequestCredentialsForAttribute3 = JSONArray(degreeRequestCredentialsSearch.fetchNextCredentials("attr3_referent", 100).get())
        val degreeRequestCredentialIdForAttribute3 = degreeRequestCredentialsForAttribute3.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 3: $degreeRequestCredentialsForAttribute3")

        val degreeRequestCredentialsForAttribute4 = JSONArray(degreeRequestCredentialsSearch.fetchNextCredentials("attr4_referent", 100).get())
        val degreeRequestCredentialIdForAttribute4 = degreeRequestCredentialsForAttribute4.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        ...
        val degreeRequestCredentialsForPredicate = JSONArray(degreeRequestCredentialsSearch.fetchNextCredentials("predicate1_referent", 100).get())
        val degreeRequestCredentialIdForPredicate = degreeRequestCredentialsForPredicate.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        ...
        val degreeRequestSchemas: String = JSONObject().put(identityCertificateSchemaId, JSONObject(identityCertificateSchemaJson)).toString()
        val degreeRequestCredentialDefs: String = JSONObject().put(identityCertificateCredDefId, JSONObject(identityCertificateCredDefJson)).toString()
        ...
        val revealedAttr1 = degreeRequestProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr1_referent")
        Log.d(TAG, "Indy: Revealed attribute 1: $revealedAttr1")
        Log.d(TAG, "Indy: Revealed attribute 1: " + revealedAttr1.getString("raw"))

        val revealedAttr2 = degreeRequestProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr2_referent")
        Log.d(TAG, "Indy: Revealed attribute 2: $revealedAttr2")
        Log.d(TAG, "Indy: Revealed attribute 2: " + revealedAttr2.getString("raw"))

        val revealedAttr3 = degreeRequestProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr3_referent")
        Log.d(TAG, "Indy: Revealed attribute 3: $revealedAttr3")
        Log.d(TAG, "Indy: Revealed attribute 3: " + revealedAttr3.getString("raw"))

        val revealedAttr4 = degreeRequestProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr4_referent")
    ...
    fun requestDegreeCertificate() {
        ...
        val bachelorCredValuesJson = JSONObject()
            .put("given_names", JSONObject().put("raw", "Alice").put("encoded", "1139481716457488690172217916278103335"))
            .put("family_name", JSONObject().put("raw", "Garcia").put("encoded", "5321642780241790123587902456789123452"))
            .put("degree", JSONObject().put("raw", "Bachelor of Science, Marketing").put("encoded", "12434523576212321"))
            .put("status", JSONObject().put("raw", "graduated").put("encoded", "2213454313412354"))
            .put("year", JSONObject().put("raw", "2020").put("encoded", "2020"))
            .put("average", JSONObject().put("raw", "5").put("encoded", "5"))
            .toString()
    ...
    fun proofRequestApplicationJob() {
        ...
        val jobApplicationCredentialsSearch = CredentialsSearchForProofReq.open(myWallet, jobApplicationProofRequestJson, null).get()

        val jobApplicationCredentialsForAttribute1 = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("attr1_referent", 100).get())
        val jobApplicationCredentialIdForAttribute1 = jobApplicationCredentialsForAttribute1.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 1: $jobApplicationCredentialsForAttribute1")


        val jobApplicationCredentialsForAttribute2 = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("attr2_referent", 100).get())
        val jobApplicationCredentialIdForAttribute2 = jobApplicationCredentialsForAttribute2.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 2: $jobApplicationCredentialsForAttribute2")


        val jobApplicationCredentialsForAttribute3 = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("attr3_referent", 100).get())
        val jobApplicationCredentialIdForAttribute3 = jobApplicationCredentialsForAttribute3.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 3: $jobApplicationCredentialsForAttribute3")


        val jobApplicationCredentialsForAttribute4 = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("attr4_referent", 100).get())
        val jobApplicationCredentialIdForAttribute4 = jobApplicationCredentialsForAttribute4.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        Log.d(TAG, "Indy: Search for Attribute 4: $jobApplicationCredentialsForAttribute4")


        val jobApplicationCredentialsForAttribute5 = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("attr5_referent", 100).get())
        ...
        val jobApplicationCredentialsForPredicate = JSONArray(jobApplicationCredentialsSearch.fetchNextCredentials("predicate1_referent", 100).get())
        val jobApplicationCredentialIdForPredicate = jobApplicationCredentialsForPredicate.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        ...
        val jobApplicationRequestedCredentialsJson = JSONObject()
            .put("self_attested_attributes", JSONObject().put("attr5_referent", jobApplicationSelfAttestedValue))
            .put("requested_attributes", JSONObject()
                .put("attr1_referent", JSONObject()
        ...
        val jobApplicationSchemas: String = JSONObject().put(degreeCertificateSchemaId, JSONObject(degreeCertificateSchemaJson)).toString()
        val jobApplicationCredentialDefs: String = JSONObject().put(degreeCertificateCredDefId, JSONObject(degreeCertificateCredDefJson)).toString()
        ...
        // 5. Verifier verifies Proof
        val revealedAttr1 = jobApplicationProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr1_referent")
        Log.d(TAG, "Indy: Revealed attribute 1: $revealedAttr1")
        Log.d(TAG, "Indy: Revealed attribute 1: " + revealedAttr1.getString("raw"))
        Log.d(TAG, "Indy: (should be not null) " + jobApplicationProof.getJSONObject("requested_proof").getJSONObject("unrevealed_attrs").getJSONObject("attr2_referent").getInt("sub_proof_index"))
        Log.d(TAG, "Indy: selfAttestedValue: " + jobApplicationSelfAttestedValue + " should be: " + jobApplicationProof.getJSONObject("requested_proof").getJSONObject("self_attested_attrs").getString("attr5_referent"))
    ...
    fun requestJobCertificate() {
        ...
        val jobCredValuesJson = JSONObject()
            .put("given_names", JSONObject().put("raw", "Alice").put("encoded", "1139481716457488690172217916278103335"))
            .put("family_name", JSONObject().put("raw", "Garcia").put("encoded", "5321642780241790123587902456789123452"))
            .put("employee_status", JSONObject().put("raw", "Permanent").put("encoded", "2143135425425143112321314321"))
            .put("salary", JSONObject().put("raw", "2400").put("encoded", "2400"))
            .put("experience", JSONObject().put("raw", "10").put("encoded", "10"))
            .toString()
    ...
    fun proofRequestApplicationLoan() {
        ...
        val loanApplicationCredentialsSearch = CredentialsSearchForProofReq.open(myWallet, loanApplicationProofRequestJson, null).get()

        val loanApplicationCredentialsForAttribute = JSONArray(loanApplicationCredentialsSearch.fetchNextCredentials("attr1_referent", 100).get())
        val loanApplicationCredentialIdForAttribute = loanApplicationCredentialsForAttribute.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        ...
        val loanApplicationCredentialsForPredicate = JSONArray(loanApplicationCredentialsSearch.fetchNextCredentials("predicate1_referent", 100).get())
        val loanApplicationCredentialIdForPredicate = loanApplicationCredentialsForPredicate.getJSONObject(0).getJSONObject("cred_info").getString("referent")
        ...
        val loanApplicationSchemas: String = JSONObject().put(jobCertificateSchemaId, JSONObject(jobCertificateSchemaJson)).toString()
        val loanApplicationCredentialDefs: String = JSONObject().put(jobCertificateCredDefId, JSONObject(jobCertificateCredDefJson)).toString()
        ...
        // 5. Verifier verifies Proof
        val revealedAttr1 = loanApplicationProof.getJSONObject("requested_proof").getJSONObject("revealed_attrs").getJSONObject("attr1_referent")
        Log.d(TAG, "Indy: Revealed attribute 1: $revealedAttr1")
        Log.d(TAG, "Indy: Revealed attribute 1: " + revealedAttr1.getString("raw"))
